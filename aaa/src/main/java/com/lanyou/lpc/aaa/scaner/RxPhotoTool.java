...
import static com.lanyou.lpc.aaa.scaner.RxFileTool.getDataColumn;
import static com.lanyou.lpc.aaa.scaner.RxFileTool.isDownloadsDocument;
import static com.lanyou.lpc.aaa.scaner.RxFileTool.isExternalStorageDocument;
import static com.lanyou.lpc.aaa.scaner.RxFileTool.isGooglePhotosUri;
import static com.lanyou.lpc.aaa.scaner.RxFileTool.isMediaDocument;
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager
            ...
            if (status.equals(Environment.MEDIA_MOUNTED)) {// 判断是否有SD卡,优先使用SD卡存储,当没有SD卡时使用手机存储
                imageFilePath[0] = context.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                        values);
            } else {
                imageFilePath[0] = context.getContentResolver().insert(MediaStore.Images.Media.INTERNAL_CONTENT_URI,
                        values);
            }
        }
