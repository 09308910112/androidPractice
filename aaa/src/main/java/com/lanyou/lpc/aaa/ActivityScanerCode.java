...
import com.lanyou.lpc.aaa.scaner.CameraManager;
import com.lanyou.lpc.aaa.scaner.CaptureActivityHandler;
import com.lanyou.lpc.aaa.scaner.OnRxScanerListener;
import com.lanyou.lpc.aaa.scaner.RxAnimationTool;
import com.lanyou.lpc.aaa.scaner.decoding.InactivityTimer;
...
public class ActivityScanerCode extends AppCompatActivity {
  ...
  //  private RxDialogSure rxDialogSure;
   ...
   protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    private void initDialogResult(Result result) {
        ...
        Toast.makeText(this, realContent, Toast.LENGTH_LONG).show();
        finish();
  ...
  /*      rxDialogSure.setOnCancelListener(new DialogInterface.OnCancelListener() {
     ...
     /*   if (!rxDialogSure.isShowing()) {
      ...
      /*  RxSPTool.putContent(mContext, RxConstants.SP_SCAN_CODE, RxDataTool.stringToInt(RxSPTool.getContent(mContext,
                RxConstants.SP_SCAN_CODE)) + 1 + "");*/
    }
